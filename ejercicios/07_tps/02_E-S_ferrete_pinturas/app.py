...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        temperatura_celsius = self.txt_temperatura_c.get()
        temperatura_celsius = float(temperatura_celsius)
        
        temperatura_fahrenheit = (temperatura_celsius * 9/5) + 32
        
        alert("mensaje", f"la temperatura es: {temperatura_fahrenheit:.2f}")
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        alert("mensaje", f"la temperatura es: {temperatura_celsius:.2f}")
