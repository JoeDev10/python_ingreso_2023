...
class App(customtkinter.CTk):
    ...
    def btn_calcular_on_click(self):
        ...
        for numero_lista in self.lista_datos:
            if numero_menor == None or numero_lista < numero_menor: 
                numero_menor = numero_lista
                
        alert("utn", f"el numero menor de la lista es: {numero_menor}")
