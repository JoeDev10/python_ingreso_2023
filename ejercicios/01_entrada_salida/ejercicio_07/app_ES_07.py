...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.btn_sumar = customtkinter.CTkButton(
            master=self, text="Sumar", command=self.btn_sumar_on_click)
        self.btn_sumar.grid(row=2, pady=10, columnspan=2, sticky="nsew")

        self.btn_restar = customtkinter.CTkButton(
            master=self, text="Restar", command=self.btn_restar_on_click)
        self.btn_restar.grid(row=3, pady=10, columnspan=2, sticky="nsew")

        self.btn_multiplicar = customtkinter.CTkButton(
            master=self, text="Multiplicar", command=self.btn_multiplicar_on_click)
        self.btn_multiplicar.grid(row=4, pady=10, columnspan=2, sticky="nsew")

        self.btn_dividir = customtkinter.CTkButton(
            master=self, text="Dividir", command=self.btn_dividir_on_click)
    ...
    def btn_restar_on_click(self):
        ...
        alert("suma:", f"el resultado de la resta es: {resultado}")
    ...
    def btn_multiplicar_on_click(self):
        ...
        alert("suma:", f"el resultado de la multiplicacion es: {resultado}")
    ...
    def btn_dividir_on_click(self):
        ...
        alert("suma:", f"el resultado de la division es: {resultado}")
